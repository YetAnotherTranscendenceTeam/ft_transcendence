...
describe('Block tests', () => {
  ...
  it("1 blocks 2", async () => {
    ...
    await user1.expectEvent("receive_new_block", { ...user2.me() });
  });
  ...
  it("1 unblocks 2", async () => {
    ...
    await user1.expectEvent("receive_delete_block", { account_id: user2.id });
  });
  ...
  it("2 unblocks 1", async () => {
    ...
    await user2.expectEvent("receive_delete_block", { account_id: user1.id });
  });
